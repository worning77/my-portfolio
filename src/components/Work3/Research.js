...
const Research = () => (
  <Container>
    <ResearchDiv>
      ...
      <Ctext>
        Because this idea is a brand new Apartment of Hotel for young, I need to
        investigate the rule of price from two angles: traditional Hotels and
        convenient long-term apartment leasing platform, like Ziroom.
      </Ctext>
    ...
    <ResearchDiv>
      ...
      <Ctext>
        ...
        <br />
        <li>Experiencing keeping pets</li>
        <li>
